...
import { create_product, product_update } from '../../api'
    ...
    const onSubmit = async (data: ProductForm) => {
      ...
      try {
        ...
        if (error?.response) {
          ...
          const action = productData ? 'update' : 'create';
          setMessage((prevMessage) => ({ ...prevMessage, error: `Product ${action} failed. Please try again.` }));
        }
      }
    };
      ...
      <>
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Button type="submit" variant="contained" color="primary">
              {productData ? 'Update' : 'Create'} Product
            </Button>
        </form>
